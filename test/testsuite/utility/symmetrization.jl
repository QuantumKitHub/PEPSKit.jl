...
function utility_symmetrization_reflect_depth(AT)
    return @testset "ReflectDepth ($AT)" for unitcell in [(1, 1), (2, 2), (3, 3), (3, 2)]
        peps = adapt(AT, InfinitePEPS(ComplexSpace(2), ComplexSpace(2); unitcell))
...
function utility_symmetrization_reflect_width(AT)
    return @testset "ReflectWidth ($AT)" for unitcell in [(1, 1), (2, 2), (3, 3), (3, 2)]
        peps = adapt(AT, InfinitePEPS(ComplexSpace(2), ComplexSpace(2); unitcell))
...
function utility_symmetrization_rotate(AT)
    return @testset "Rotate ($AT)" for unitcell in [(1, 1), (2, 2), (3, 3)]
        peps = adapt(AT, InfinitePEPS(ComplexSpace(2), ComplexSpace(2); unitcell))
...
function utility_symmetrization_rotate_reflect(AT)
    return @testset "RotateReflect ($AT)" for unitcell in [(1, 1), (2, 2), (3, 3)]
        peps = adapt(AT, InfinitePEPS(ComplexSpace(2), ComplexSpace(2); unitcell))
