...
function bondenv_gaugefix(AT)
    return @testset "BondEnv gaugefixing ($AT)" begin
        ...
        for V1 in Vs, V2 in Vs, V3 in Vs
            #=
                ...
                └---┴-------Z0------┴---┘       ↓
                            ...
                            -1
            =#
            X = adapt(AT, rand(ComplexF64, Vin ⊗ V1' ⊗ Vin' ⊗ Vin))
            Y = adapt(AT, rand(ComplexF64, Vin ⊗ Vin ⊗ Vin' ⊗ V3))
            Z0 = adapt(AT, randn(ComplexF64, Vphy ← Vin ⊗ Vin' ⊗ Vin ⊗ Vin ⊗ Vin ⊗ Vin'))
            ...
            #= 
                ...
                └---Z-- 1 --a-- 2 --b-- 3 --┘
                    ...
                    -1      -2      -3
            =#
            a = adapt(AT, randn(ComplexF64, V1 ⊗ Vphy ← V2))
            b = adapt(AT, randn(ComplexF64, V2 ⊗ Vphy ← V3))
