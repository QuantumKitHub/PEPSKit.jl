...
"Check positivity and gauge fixing of a neighbourhood bond environment."
...
"Check neighbourhood bond environments and their gauge transformations."
function bondenv_ntu(AT)
    Random.seed!(20)
    return @testset "NTU bond environment ($(sym), $AT)" for sym in [U1Irrep, FermionParity]
