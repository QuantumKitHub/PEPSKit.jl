...
function examples_bose_hubbard(AT)
    return @testset "Bose Hubbard ($AT)" begin
        ...
        # Hamiltonian
        H = adapt(AT, bose_hubbard_model(ComplexF64, symmetry, lattice; cutoff, t, U, n))
        ...
        ψ₀ = adapt(AT, InfinitePEPS(randn, ComplexF64, Pspaces, Nspaces, Espaces))
        env₀ = CTMRGEnv(ψ₀, Venv)
