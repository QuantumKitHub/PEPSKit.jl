...
function test_ctmrg_contractions(
        AT, Pspaces, Nspaces, Espaces, chis_north, chis_east, chis_south, chis_west,
    )

    @testset "CTMRG PEPS contractions" begin
        peps = adapt(AT, InfinitePEPS(randn, stype, Pspaces, Nspaces, Espaces))
