...
function get_hubbard_state(t::Float64 = 1.0, U::Float64 = 8.0)
    ...
    wts = SUWeight(peps)
    alg = SimpleUpdate(1.0e-2, 1.0e-8, 10000, truncerror(1.0e-10) & truncrank(4))
...
ctm_alg = SequentialCTMRG(; tol = 1.0e-10, verbosity = 2, trscheme = truncerror(1.0e-10) & truncrank(8))
