...
function crosstransfer(v::MPSBondTensor,a::GenericMPSTensor,b::GenericMPSTensor)
    @tensor dst[-1;-2] := v[1,2]*a[2,3,4,-2]*b[-1,3,4,1]
end

# a single peps tensor
function crosstransfer(v::GenericMPSTensor,O::AbstractArray,A::AbstractArray,B::AbstractArray;dir = North,bO=O)
...
function crosstransfer(v::GenericMPSTensor,o::PEPSType,a::GenericMPSTensor,b::GenericMPSTensor;dir=North,bo::PEPSType=o)
...
function crosstransfer(v::GenericMPSTensor,O1::AbstractArray,O2::AbstractArray,A::AbstractArray,B::AbstractArray;dir=North)
...
function crosstransfer(v::GenericMPSTensor,o1::PEPSType,o2::PEPSType,a::GenericMPSTensor,b::GenericMPSTensor;dir=North)
...
function MPSKit.transfer_left(v::M,o::T,a::M, b::M,bo::T=o) where T <: PEPSType where M <: GenericMPSTensor
