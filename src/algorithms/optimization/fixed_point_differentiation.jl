...
function LinSolver(;
    solver=Defaults.gradient_linsolver, iterscheme=Defaults.gradient_alg_iterscheme
)
...
function EigSolver(;
    solver=Defaults.gradient_eigsolver, iterscheme=Defaults.gradient_alg_iterscheme
)
