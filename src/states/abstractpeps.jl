...
# Rotations
Base.rotl90(t::PartitionFunctionTensor) = permute(t, ((3, 1), (4, 2)))
Base.rotr90(t::PartitionFunctionTensor) = permute(t, ((2, 4), (1, 3)))
Base.rot180(t::PartitionFunctionTensor) = permute(t, ((4, 3), (2, 1)))
