...
# ╔═╡ ba89666b-25ff-432c-a661-7fb4a111f075
using Random

# ╔═╡ b859e9b7-2573-47cb-b626-bf6515d74a02
using TensorKit, PEPSKit, MPSKit

# ╔═╡ a225cdc1-5a75-4e61-af51-226e05fc1243
md"""
...
# ╔═╡ 687f9c44-3c79-4bef-9ab3-647c4cdc866f
Random.seed!(29384293742893);

# ╔═╡ d211a23c-9bf6-4d9d-b0ff-386d6c9e38f4
md"""
Besides `TensorKit` and `PEPSKit`, we here also need [`MPSKit`](https://quantumkithub.github.io/MPSKit.jl/stable/) which implements the VUMPS algorithm as well as the required MPS operations:
"""

# ╔═╡ db11c7b7-0a45-43ba-8d50-66e7fb616145
md"""
...
# ╔═╡ de769e61-4e2e-4954-8d26-33b5078a6a4c
peps₀ = InfinitePEPS(ComplexSpace(2), ComplexSpace(2));

# ╔═╡ 8a517a82-a63a-4ef6-95bc-0603163f05b7
md"""
...
# ╔═╡ 42a6c723-268f-4c21-97c3-77887ef0504e
transfer = InfiniteTransferPEPS(peps₀, 1, 1);

# ╔═╡ bdf74a84-d072-4275-9214-75aa650028c2
md"""
...
# ╔═╡ 079e54e7-e68d-4e77-b3a7-a61dce3311ed
mps₀ = initializeMPS(transfer, [ComplexSpace(20)]);

# ╔═╡ bc347368-d374-4ab2-bfdd-90e8084f3aec
md"""
...
# ╔═╡ a01f3061-e9d8-42b9-ba7c-876d7fa084fe
mps, env, ϵ = leading_boundary(mps₀, transfer, VUMPS(; verbosity=2));

# ╔═╡ 608035ff-4eb1-42f5-8cf7-b39f2f38f36f
md"""
...
# ╔═╡ ba5a3c16-cd8a-4f49-9af4-d2bcea0c7fc5
...
# ╔═╡ 4ce07126-926d-4698-823c-25c36ff9f6eb
md"""
...
# ╔═╡ cae6ce02-fd27-4ae3-bb0c-4bb53f48ca38
pepo = ising_pepo(1);

# ╔═╡ 63083f5c-1881-4577-a5c0-a5db4778832a
transfer_pepo = InfiniteTransferPEPO(peps₀, pepo, 1, 1);

# ╔═╡ 2e21289d-9347-4b0c-80ef-18c02e5cbba8
md"""
...
md"""
These objects and routines can be used to optimize PEPS fixed points of 3D partition functions, see for example [Vanderstraeten et al.](@cite vanderstraeten_residual_2018)
"""
