...
H = adapt(CuArray, heisenberg_XYZ(ComplexF64, InfiniteSquare(); Jx = -1, Jy = 1, Jz = -1))
...
peps₀ = InfinitePEPS(randn, CuMatrix{ComplexF64}, ℂ^2, ℂ^Dbond)
...
env_random = CTMRGEnv(randn, CuMatrix{ComplexF64}, peps₀, ℂ^χenv);
