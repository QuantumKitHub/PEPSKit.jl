...
using Random
using TensorKit, PEPSKit, CUDA, cuTENSOR, MPSKitModels
using PEPSKit.MatrixAlgebraKit
...
n = 1
# TODO make this GPU 
H = bose_hubbard_model(CuMatrix{ComplexF64}, symmetry, lattice; cutoff, t, U, n);
...
boundary_alg = (; tol = 1.0e-8, alg = :simultaneous, svd_alg = SVDAdjoint(; fwd_alg = CUSOLVER_Jacobi()), trunc = (; alg = :fixedspace))
...
peps₀ = InfinitePEPS(randn, ComplexF64, CuMatrix{ComplexF64}, physical_spaces, virtual_spaces)
